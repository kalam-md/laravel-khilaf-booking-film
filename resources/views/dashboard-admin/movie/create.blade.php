...
@section('container')
    ...
    <div class="max-w-2xl">
        <form class="space-y-8"  action="/dashboard-admin/movies" method="post" enctype="multipart/form-data">
        @csrf
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            <div>
                <h3 class="text-lg leading-6 font-medium text-gray-900">Movie Create</h3>
            ...
            <div class="space-y-6 sm:space-y-5">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="text" name="name" id="name" autocomplete="given-name" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-lg sm:text-sm border-gray-300 rounded-md @error('name') is-invalid @enderror" required value="{{ old('name') }}">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="text" name="trailer" id="trailer" autocomplete="given-trailer" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-lg sm:text-sm border-gray-300 rounded-md @error('trailer') is-invalid @enderror" required value="{{ old('trailer') }}">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <textarea rows="4" name="synopsis" id="synopsis" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-lg sm:text-sm border-gray-300 rounded-md @error('synopsis') is-invalid @enderror" required></textarea>
