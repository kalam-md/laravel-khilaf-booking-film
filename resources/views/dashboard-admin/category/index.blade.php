              ...
              <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                  <tr>
                    <th scope="col"
                      ...
                      Category ID</th>
                    <th scope="col"
                      class="whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-gray-900">Category
                      Name
                    </th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  ...
                  <tr>
                    ...
                    <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">{{ $category->name }}</td>
                    <td class="relative whitespace-nowrap py-2 text-right text-sm font-medium flex">
                      <a href="/dashboard-admin/categories/{{ $category->id }}/edit" class="text-gray-400 hover:text-gray-500 mr-2">
                      ...
                      <form action="/dashboard-admin/categories/{{ $category->id }}" method="post">
                        @method('delete')
                        @csrf
