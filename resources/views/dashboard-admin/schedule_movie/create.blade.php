...
@section('container')
    ...
    <div class="max-w-2xl">
        <form class="space-y-8"  action="/dashboard-admin/schedule-movies" method="post">
        @csrf
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            <div>
                <h3 class="text-lg leading-6 font-medium text-gray-900">Schedule Movie Create</h3>
            ...
            <div class="space-y-6 sm:space-y-5">
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <input type="date" name="start_date" id="start_date" autocomplete="given-start_date" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-lg sm:text-sm border-gray-300 rounded-md @error('start_date') is-invalid @enderror" required value="{{ old('start_date') }}">
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <input type="number" name="price" id="price" autocomplete="given-price" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-lg sm:text-sm border-gray-300 rounded-md @error('price') is-invalid @enderror" required value="{{ old('price') }}">
